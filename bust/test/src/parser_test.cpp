...
TEST_SUITE("bust.parser") {
  ...
  TEST_CASE("bust::parse_minimal_function") {
    ...
    REQUIRE(func.m_return_type.has_value());
    CHECK(func.m_return_type->m_type_string == "i64");
  }
  ...
  TEST_CASE("bust::parse_function_no_return_type") {
    ...
    CHECK_FALSE(func.m_return_type.has_value());
  ...
  TEST_CASE("bust::parse_function_with_params") {
    ...
    CHECK(func.m_parameters[0].m_type->m_type_string == "i64");
    CHECK(func.m_parameters[1].m_name == "b");
    REQUIRE(func.m_parameters[1].m_type.has_value());
    CHECK(func.m_parameters[1].m_type->m_type_string == "i64");
  }
  ...
  TEST_CASE("bust::parse_top_level_let") {
    ...
    CHECK(binding.m_variable.m_type->m_type_string == "i64");
  ...
  TEST_CASE("bust::parse_lambda_with_params") {
    ...
    CHECK(lambda.m_return_type->m_type_string == "i64");
  }
